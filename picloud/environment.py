...
class CloudEnvironmentResource(CloudResource):
    ...
    @dispatch("/list_bases/")
    def list_bases_hnd(self, request, **kwrags):
        return self.create_response(request, {})
    ...
    @dispatch
    def edit_info_hnd(self, request, **kwrags):
        return self.create_response(request, {})
    
    @dispatch
    def modify_hnd(self, request, **kwrags):
        return self.create_response(request, {})

    @dispatch
    def save_hnd(self, request, **kwrags):
        return self.create_response(request, {})
    
    @dispatch
    def save_shutdown_hnd(self, request, **kwrags):
        return self.create_response(request, {})
    
    @dispatch
    def shutdown_hnd(self, request, **kwrags):
        return self.create_response(request, {})
    
    @dispatch
    def clone_hnd(self, request, **kwrags):
        return self.create_response(request, {})
